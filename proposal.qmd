...
|----------|----------|----------|----------|----------|----------------------|
| Create the proposal        | Pending | All members        | 03 April | High     | Create the initial documented proposal           |
| Create the Git Repo        | Pending | All members        | 03 April | Moderate | Create a new repository for data                 |
| Resubmit proposal          | Pending | All members        | 08 April | High     | Resubmit revised proposal                        |
| Data wrangling             | Pending | Sub-groups 1 and 2 | 08 April | Moderate | Initial exploration and cleaning of the datasets |
| Analysis of topic one      | Pending | Sub-group 1        | 15 April | Moderate |                                                  |
| Analysis of topic two      | Pending | Sub-group 2        | 22 April | Low      |                                                  |
| Plotting for topic one     | Pending | Sub-group 1        | 29 April | Low      |                                                  |
| Plotting for topic two     | Pending | Sub-group 2        | 29 April | Low      |                                                  |
| Summarising of information | Pending | All members        | 01 May   | Low      |                                                  |
| Write up                   | Pending | Sub-group 1        | 06 May   | Low      |                                                  |
| Presentation               | Pending | Sub-group 2        | 06 May   | Low      |                                                  |
| Final organisation         | Pending | All members        | 06 May   | Low      |                                                  |
| Site publishing            | Pending | All members        | 06 May   | Low      |                                                  |
| Final submission           | Pending | All members        | 06 May   | Low      | Final submission of the entire repository        |
