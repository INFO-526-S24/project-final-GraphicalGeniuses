...
#animate(complexAnimation, renderer = av_renderer("data/animation.mp4"), height = 1000, width = 1300, duration = 120)
...
#| fig-asp: 0.618
#| fig-width: 20
pacman::p_load(plotly, grDevices)
...
worldChanged2 <- left_join(worldChanged, select(world, c("geounit", "geometry")), by = c("Country" = "geounit"))

#worldChanged3 <- worldChanged2 %>%
  #mutate(textToDisplay = case_when(
